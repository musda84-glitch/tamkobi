...
export const QUICK_TILES: QuickTile[] = [
  ...
  { id: "banking", label: "Banka", path: "/banking", href: "/banking", icon: "wallet", tone: "teal" },
  ...
  { id: "sevk", label: "Depo", path: "/sevk", href: "/sevk", icon: "cube", tone: "teal" },
  { id: "atolye", label: "Atölye", path: "/atolye", href: "/atolye", icon: "build", tone: "orange" },
