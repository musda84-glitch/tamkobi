  ...
  return (
    <div className="space-y-4 text-xs" data-testid="b2b-settings">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-5 space-y-3">
        <div className="flex items-center justify-between"><div><div className="text-sm font-bold text-slate-900">B2B Portal Özellikleri</div><div className="text-slate-500">Müşterileriniz <b>{window.location.origin}/b2b/giris</b> adresinden e-posta/VKN + şifre ile (veya /portal/… linkiyle) girer; {d.active_count} müşteri aktif.</div></div><span className={`px-2 py-1 rounded-lg font-bold ${st.enabled ? "bg-emerald-50 text-emerald-700" : "bg-rose-50 text-rose-700"}`}>{st.enabled ? "AÇIK" : "KAPALI"}</span></div>
