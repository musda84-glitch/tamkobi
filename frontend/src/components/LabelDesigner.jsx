      ...
      <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[92vh] overflow-y-auto p-5 space-y-3 text-xs text-slate-800" onClick={(e) => e.stopPropagation()} data-testid="print-barcode-modal">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <b className="text-sm flex items-center gap-2 text-slate-900"><Tag className="w-4 h-4 text-emerald-600" /> Barkod Etiketi Önizleme</b>
            ...
            {product?.label_template_id && (tpl?.id === product.label_template_id || tpl?._id === product.label_template_id) && (
              <div className="text-[10px] text-emerald-700 font-semibold mt-0.5" data-testid="label-quick-assigned">Stok kartındaki etiket tasarımı</div>
            )}
          </div>
