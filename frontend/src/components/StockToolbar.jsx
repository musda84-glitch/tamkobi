...
export const StockToolbar = ({ categories, filterCategory, setFilterCategory, f, setF, search, setSearch, count, stockValue, criticalCount, rows = [], onReorderCritical }) => {
