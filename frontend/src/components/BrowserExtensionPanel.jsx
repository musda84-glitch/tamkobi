    ...
    <div className="space-y-4 max-w-2xl" data-testid="browser-extension-panel">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1 leading-relaxed">
              Panel, Hızlı Satış, Faturalar, Stok, Sistem ve Web sayfalarına tek tıkla gidin.
              Chrome, Edge ve Brave (Manifest V3) ile Firefox desteklenir.
            </p>
          </div>
        </div>
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 space-y-3 text-xs text-slate-700">
        ...
        <ol className="list-decimal pl-4 space-y-1.5 leading-relaxed">
          ...
          <li>
            Eklenti ikonuna tıklayıp <b>Kurulum adresi</b> alanına şunu yazın:{" "}
