...
export const TEMPLATES = {
  ...
  invoice: (inv) => `Sayın ${inv.contact_name}, ${inv.invoice_number} numaralı ${formatTrAmount(inv.grand_total)} ₺ tutarındaki faturanız düzenlenmiştir.${inv.due_date ? ` Son ödeme tarihi: ${fmtDate(inv.due_date)}.` : ""} Teşekkür ederiz.`,
