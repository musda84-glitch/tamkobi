    ...
    <form onSubmit={save} className="space-y-4" data-testid="saas-settings">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-4 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div><label className="block font-semibold text-slate-700 mb-1">Site adresi (takibi.com vitrini ve yenileme linkleri)</label><input value={s.public_url || ""} onChange={(e) => setS({ ...s, public_url: e.target.value })} placeholder="https://takibi.com" className={inputCls} data-testid="set-public-url" /></div>
