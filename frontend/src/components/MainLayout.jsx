...
export default function MainLayout({ children, onOpenQuickAction }) {
  ...
  const routeKey = { "/sevk": "/orders", "/sayim": "/stock", "/edoc-inbox": "/invoices", "/mesai": "/personnel", "/b2b-yonetim": "/contacts" }[location.pathname] || location.pathname;
