...
export const SYSTEM_NAV_GROUPS = [
  ...
  { id: "entegrasyon", label: "Entegrasyon", paths: ["/sistem/posta", "/sistem/sms", "/sistem/ai", "/sistem/araclar"] },
...
export const SETTINGS_TAB_GROUPS = [
  ...
  { id: "kurallar", label: "Kurallar", tabs: ["units", "project_stages", "work_parks", "workshop_zones", "users"] },
