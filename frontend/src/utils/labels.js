...
export const CHANNEL_TR = { manual: "Manuel", b2b: "B2B", trendyol: "Trendyol", hepsiburada: "Hepsiburada", amazon: "Amazon", shopify: "Shopify", n11: "N11", woocommerce: "WooCommerce", ciceksepeti: "Çiçeksepeti", pazarama: "Pazarama", sms: "SMS", email: "E-posta", whatsapp: "WhatsApp" };
...
export const E_TYPE_TR = { e_invoice: "E-Fatura", e_archive: "E-Arşiv", paper: "Kağıt Fatura", e_dispatch: "E-İrsaliye" };
export const INVOICE_TYPE_TR = { sales: "Satış", purchase: "Alış", proforma: "Proforma", return: "İade" };
